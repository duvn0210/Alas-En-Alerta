...
function SideMenu() {
  return (
    <aside className="w-[300px] bg-white flex flex-col justify-between items-center shadow-lg">
      <div className="space-y-[38px]">
        ...
        <div>
            <img src={Logo} alt="logo" className='w-28 h-28 relative left-[110px] z-10' />
        </div>
